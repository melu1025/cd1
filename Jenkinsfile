    ...
    stages {
        ...
        stage('Init') {
            ...
            steps {
                ...
                sh 'rm -rf .extras/doc/projekthandcd/html'

                // https://www.jenkins.io/doc/pipeline/steps/git
                // "named arguments" statt Funktionsaufruf mit Klammern
                git url: 'https://github.com/juergenzimmermann/cd', branch: 'main', poll: true
            }
        }
        ...
        stage('Install') {
            steps {
                ...
                // /var/jenkins_home/workspace/cd (siehe "pwd" oben)
                sh 'cat package.json'
        ...
        stage('Test, Codeanalyse, Security, Dok.') {
            ...
            post {
                ...
                success {
                    script {
                        if (fileExists("${env.WORKSPACE}/cd.zip")) {
                            sh 'rm cd.zip'
                        }
                    }
